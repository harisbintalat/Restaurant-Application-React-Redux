...
class Contact extends Component {
    ...
    handleSubmit(values) {
        this.props.postContact(this.props.contactId, values.firstname, values.lastname, values.email, values.telnum , values.message);
                        ...
                        <div className="col-2 col-md-9">
                            <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                                ...
                                <Row className='form-group'>
                                    ...
                                    <Col md={10}>
                                        <Control.text model=".telnum" className='form-control' id="telnum" name="telnum" placeholder="Contect Telephone"
                                            validators={{
